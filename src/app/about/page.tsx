  ...
  return (
    <div className=''>
      ...
      <section className='px-10'>
        <h1 className=''>THE BRANDS DOOR GROUP UNIQUE VALUES</h1>
        <h1 className='pt-5 font-bold'>INVITING STYLE</h1>
        ...
        <h1 className='pt-5 font-bold'>BUILT TO LAST</h1>
        ...
        <h1 className='pt-5 font-bold'>SUPERIOR PERFORMANCE</h1>
        ...
        <h1 className='pt-5 font-bold'>PURPOSEFUL FUNCTION</h1>
