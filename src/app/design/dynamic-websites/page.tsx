...
export default function Dynamicwebsite() {
    ...
    <section className='pt-20'>
      ...
      <section className="m-10">
        <h1 className="text-2xl tracking-[0.035em] font-bold dark:text-[#fdd007] leading-6">Dynamic Website Design Services</h1>
        <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white">{establishContent}</p>
        <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white"><span className='font-bold leading-8 tracking-[0.035em] dark:text-[#fdd007]'>Dynamic Website design</span> {dynamicWebsitedesign }</p>
