    ...
    <section className="p-10 md:p-20">
      ...
      <section className='Marketing lg:p-10'>
        ...
        <div className="flex justify-around flex-col lg:flex-row">
          <h1 className="text-4xl font-bold text-blue-500 text-center">100+ <span className="font-light text-black text-sm dark:text-[#fefde7]"><br />Total Website Traffic</span></h1>
          <h1 className="text-4xl font-bold text-blue-500 text-center">10 CR+<span className="font-light text-black text-sm dark:text-[#fefde7]"><br />Ecommerce Transaction</span></h1>
          <h1 className="text-4xl font-bold text-blue-500 text-center">2500+<span className="font-light text-black text-sm dark:text-[#fefde7]"><br />Non Branded Keywords</span></h1>
          <h1 className="text-4xl font-bold text-blue-500 text-center">100K+<span className="font-light text-black text-sm dark:text-[#fefde7]"><br />Leads Generated</span></h1>
        </div>
