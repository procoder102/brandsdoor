...
export default function Staticwebsite() {
    ...
    <section className='pt-20'>
      ...
      <section className="m-10">
        <h1 className="text-2xl tracking-[0.035em] font-bold dark:text-[#fdd007] leading-6">Static  Website Design Services</h1>
        <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white">{establishContent}</p>
        <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white"><span className='font-bold leading-8 tracking-[0.035em] dark:text-[#fdd007]'>Static  Website design</span> {dynamicWebsitedesign }</p>
        
            <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white">For <span className='font-bold dark:text-[#fdd007]'>Custom Static  Web Designs,</span>{CompleatesocialMedia}</p>
            <p className="pt-5 leading-8 tracking-[0.035em] whitespace-pre-wrap dark:text-white">For <span className='font-bold dark:text-[#fdd007]'>Custom Static  Design with Shopping cart</span>{customDesignShopping}</p>
      <Requestcard />
      </section>
    </section>
  )
